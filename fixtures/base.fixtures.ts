...
import type { AppModules, AppLocs, AppActs, AppQueries, AppA11y } from '../helpers';
import { getModules, createLoc, createAct, createQuery, createA11y } from '../helpers';
...
export const test = base.extend<MyFixtures>({
  ...
  a11y: async ({ _modules }, use) => await use(createA11y(_modules)),
});
